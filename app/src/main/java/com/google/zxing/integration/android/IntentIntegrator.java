 ...
 * the method {@link Activity#(int, int, Intent)} and include a line of code like this:</p>
 *
 * <pre>{@code
 ...
 * In particular, ideally, the app dismisses the dialog if it's still active in its {@link Activity#()}
 * method.</p>
 *
...
public class IntentIntegrator {
     ...
     * {@link Activity#(int, int, Intent)} method.</p>
     *
